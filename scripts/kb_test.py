...
def main():
    ...
    hd = HicoDetSplitBuilder.get_split(HicoDetSplit, Splits.TRAIN)  # type: HicoDetSplit
    ...
    hd = HicoDetSplitBuilder.get_split(HicoDetSplit, Splits.TEST)  # type: HicoDetSplit
    if 1:
